          ...
          <div data-parallax="reverse">
            ...
            <div className="mt-9 flex flex-col gap-4 border-t border-burgundy/20 pt-7 sm:flex-row sm:items-center sm:justify-between">
              <p className="max-w-xl text-sm leading-6 text-charcoal/65">
                Partner spaces are intentionally reserved for values-aligned
                collaborators. Real partner logos can be added when supplied.
              </p>
              <Button href={`mailto:hello@ladiesspace.gm?subject=Partnership%20with%20Ladies'%20Space`}>
